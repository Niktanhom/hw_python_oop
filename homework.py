...
class Running(Training):                                        
    ...
    def get_spent_calories(self) -> float:
        calories = ((self.COEFF_C_RUN_1 * self.get_mean_speed() - self.COEFF_C_RUN_2) * self.weight / self.M_IN_KM * (self.duration * 60))
        return calories
...
class SportsWalking(Training):                                  
    ...
    def get_spent_calories(self) -> float:
        calories = (self.COEFF_C_WALK_1 * self.weight + (self.get_mean_speed()**2 // self.height)
                    * self.COEFF_C_WALK_2 * self.weight) * (self.duration * 60)
        return calories
